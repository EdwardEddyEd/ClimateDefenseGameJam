function HydroProjectile(state, x, y, theta, damage, renderTarget, enemyTarget){
	PIXI.Sprite.call(this, textureManager.getTexture("hydroTower_Proj_Horiz"));	
...
HydroProjectile.prototype = Object.create(PIXI.Sprite.prototype);
...
HydroProjectile.prototype.tick = function(delta){
	...
	if(!this.isCollided){
		...
		switch(this.deathFrames){
			case 8:
				this.texture = textureManager.getTexture("hydroTower_Proj_Break1");
				break;
			case 4:
				this.texture = textureManager.getTexture("hydroTower_Proj_Break2");
				break;
			case 0:
				this.deleteSelf();
				break;
...
HydroProjectile.prototype.checkCollision = function(){
...
HydroProjectile.prototype.deleteSelf = function(){
